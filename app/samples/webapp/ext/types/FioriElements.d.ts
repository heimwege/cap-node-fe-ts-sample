...
type ControllerExtensionOverrides = Partial<
    Pick<(typeof Controller)['prototype'], 'onAfterRendering' | 'onBeforeRendering' | 'onExit' | 'onInit'>
>;
